...
![](images/Screenshot 2024-03-10 at 5.47.08 PM.png){fig-align="center" width="600"}
...
#### why i used Scatter Plot: 

1.  **Relationship Analysis:** Scatter plots visualize relationships between two variables.

2.  **Strength Assessment:** Spread of points indicates the strength of the relationship.

3.  **Identification of Outliers:** High-value points highlight notable instances in the data.
